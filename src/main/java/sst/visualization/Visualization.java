...
public abstract class Visualization {
     ...
     *
     * @param table
     *         the table to be plotted only numeric columns will be plotted for hour. so
     *         string and boolean columns will be ignored.
     * @param columns
     *         if supplied is the columns which should be plotted
     * @param xLabelColumn
     *         the name of the column to be used as labels in the X scale.
